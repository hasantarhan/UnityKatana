...
namespace Lean.Touch
{
	...
	public class LeanDragTranslate : MonoBehaviour
	{
		...
		protected virtual void Update()
		{
			...
			LimitPosition(transform,target,maxDistance);
		...
		private void LimitPosition( Transform transform1, Transform transform2, float maxDistance )
		{
			...
			{
				transform1.transform.position = direction.normalized * maxDistance + position1;
			}
		}
	}
}