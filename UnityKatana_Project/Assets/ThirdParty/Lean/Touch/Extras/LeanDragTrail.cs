...
namespace Lean.Touch
{
    ...
    public class LeanDragTrail : MonoBehaviour
    {
        ...
        public LeanScreenDepth ScreenDepth = new LeanScreenDepth(LeanScreenDepth.ConversionType.FixedDistance,
            Physics.DefaultRaycastLayers, 10.0f);
        ...
        protected virtual void Update()
        {
            ...
            for (var i = 0; i < fingers.Count; i++)
            {
                ...
                if (LeanFingerData.Exists(fingerDatas, finger) == false)
                {
                    ...
                    if (MaxTrails >= 0 && LeanFingerData.Count(fingerDatas) >= MaxTrails) continue;
        ...
        protected virtual void HandleFingerUp(LeanFinger finger)
        {
            ...
            if (link != null) link.Finger = null; // The line will gradually fade out in Update
        }
